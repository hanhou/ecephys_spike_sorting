...
def createInputJson(output_file,
    ...
    catGTPath = r'D:\Han_Sync\Svoboda\Scripts\Ephys\CatGT_1.9'
    tPrime_path=r'D:\Han_Sync\Svoboda\Scripts\Ephys\TPrime_1.6'
    cWaves_path=r'D:\Han_Sync\Svoboda\Scripts\Ephys\C_Waves_1.8'


    # for config files and kilosort working space
    kilosort_output_tmp = r'I:\kilosort_datatemp'
