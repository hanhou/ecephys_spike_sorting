...
catGT_cmd_string = ('-prb_fld -out_prb_fld '  # Mandatory
                    ...
                    f'{other_npx_sync} '
                    f'-XA=1,0.5,2.5,0 '  # left lick
                    f'-XA=2,0.5,2.5,0 '  # right lick
                    f'-XD={n_XAs},1,0 '   # Bpod trial trigger
                    f'-XD={n_XAs},4,0 '  # Zaber
                    f'-XD={n_XAs},5,0 '  # Camera 1 (300 Hz)
                    f'-XD={n_XAs},6,0 '  # Camera 2 (300 Hz)
                    f'-XD={n_XAs},7,0 '  # Camera 3 (100 Hz)
                    )
